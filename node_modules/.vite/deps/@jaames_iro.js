//#region node_modules/@jaames/iro/dist/iro.es.js
/*!
* iro.js v5.5.2
...
function b(n, l, u, t, i, r, o, c, s) {
	var h, v, p, d, y, m, g, k = u && u.__k || e, _ = k.length;
	if (c == f && (c = null != r ? r[0] : _ ? w(u, 0) : null), h = 0, l.__k = x(l.__k, function(u) {
		if (null != u) {
			if (u.__p = l, u.__b = l.__b + 1, null === (p = k[h]) || p && u.key == p.key && u.type === p.type) k[h] = void 0;
			else for (v = 0; v < _; v++) {
			...
			if (d = $(n, u, p = p || f, t, i, r, o, null, c, s), (v = u.ref) && p.ref != v && (g || (g = [])).push(v, u.__c || d, u), null != d) {
				if (m ??= d, null != u.l) d = u.l, u.l = null;
...
function x(n, l, u) {
	if (u ??= [], null == n || "boolean" == typeof n) l && u.push(l(null));
	else if (Array.isArray(n)) for (var t = 0; t < n.length; t++) x(n[t], l, u);
	else u.push(l ? l(y(n)) : n);
	return u;
}
...
function N(n, l, u, t, i) {
	var r, o, f, e, c;
	if ("key" === (l = i ? "className" === l ? "class" : l : "class" === l ? "className" : l) || "children" === l);
	else if ("style" === l) if (r = n.style, "string" == typeof u) r.cssText = u;
	else {
...
function $(l, u, t, i, r, o, f, e, c, a) {
	var h, v, p, y, w, g, k, _, C, P, N = u.type;
	if (void 0 !== u.constructor) return null;
	(h = n.__b) && h(u);
	try {
		n: if ("function" == typeof N) {
			if (_ = u.props, C = (h = N.contextType) && i[h.__c], P = h ? C ? C.props.value : h.__p : i, t.__c ? k = (v = u.__c = t.__c).__p = v.__E : ("prototype" in N && N.prototype.render ? u.__c = v = new N(_, P) : (u.__c = v = new m(_, P), v.constructor = N, v.render = H), C && C.sub(v), v.props = _, v.state || (v.state = {}), v.context = P, v.__n = i, p = v.__d = !0, v.__h = []), v.__s ?? (v.__s = v.state), null != N.getDerivedStateFromProps && s(v.__s == v.state ? v.__s = s({}, v.__s) : v.__s, N.getDerivedStateFromProps(_, v.__s)), p) null == N.getDerivedStateFromProps && null != v.componentWillMount && v.componentWillMount(), null != v.componentDidMount && f.push(v);
			else {
...
function z(n, l, u, t, i, r, o, c) {
	var s, a, h, v, p = u.props, d = l.props;
	if (i = "svg" === l.type || i, null == n && null != r) {
		for (s = 0; s < r.length; s++) if (null != (a = r[s]) && (null === l.type ? 3 === a.nodeType : a.localName === l.type)) {
			n = a, r[s] = null;
			break;
		}
	}
...
n = {}, m.prototype.setState = function(n, l) {
	...
	for (var t; l = l.__p;) if ((t = l.__c) && !t.__p) try {
		if (t.constructor && null != t.constructor.getDerivedStateFromError) t.setState(t.constructor.getDerivedStateFromError(n));
		else {
	...
	*/
	...
	_proto.set = function set(value) {
		if (typeof value === "string") {
			if (/^(?:#?|0x?)[0-9a-fA-F]{3,8}$/.test(value)) this.hexString = value;
			else if (/^rgba?/.test(value)) this.rgbString = value;
			else if (/^hsla?/.test(value)) this.hslString = value;
		} else if (typeof value === "object") {
			if (value instanceof IroColor) this.hsva = value.hsva;
			else if ("r" in value && "g" in value && "b" in value) this.rgb = value;
			else if ("h" in value && "s" in value && "v" in value) this.hsv = value;
			else if ("h" in value && "s" in value && "l" in value) this.hsl = value;
			else if ("kelvin" in value) this.kelvin = value.kelvin;
	...
	IroColor.kelvinToRgb = function kelvinToRgb(kelvin) {
		...
		if (temp < 66) {
			r = 255;
			g = -155.25485562709179 - .44596950469579133 * (g = temp - 2) + 104.49216199393888 * log(g);
	...
	IroColor.rgbToKelvin = function rgbToKelvin(rgb) {
		...
		while (maxTemp - minTemp > eps) {
			...
			if (_rgb.b / _rgb.r >= b / r) maxTemp = temp;
			else minTemp = temp;
		}
		return temp;
	};
	_createClass(IroColor, [
		...
		},
		{
			...
			set: function set(value) {
				this.hsv = _extends({}, this.hsv, { a: value });
			}
		},
		{
			key: "kelvin",
		...
		},
		{
			...
			set: function set(value) {
				this.rgb = _extends({}, this.rgb, { r: value });
			}
		},
		{
			key: "green",
			...
			set: function set(value) {
				this.rgb = _extends({}, this.rgb, { g: value });
			}
		},
		{
			key: "blue",
			...
			set: function set(value) {
				this.rgb = _extends({}, this.rgb, { b: value });
			}
		},
		{
			key: "rgb",
			get: function get() {
				var _IroColor$hsvToRgb = IroColor.hsvToRgb(this.$), r = _IroColor$hsvToRgb.r, g = _IroColor$hsvToRgb.g, b = _IroColor$hsvToRgb.b;
				return {
					r: round(r),
					g: round(g),
					b: round(b)
			...
			set: function set(value) {
				this.hsv = _extends({}, IroColor.rgbToHsv(value), { a: value.a === void 0 ? 1 : value.a });
			}
		},
		{
			key: "rgba",
			get: function get() {
				return _extends({}, this.rgb, { a: this.alpha });
			},
			set: function set(value) {
				this.rgb = value;
			}
		},
		{
			key: "hsl",
			get: function get() {
				var _IroColor$hsvToHsl = IroColor.hsvToHsl(this.$), h = _IroColor$hsvToHsl.h, s = _IroColor$hsvToHsl.s, l = _IroColor$hsvToHsl.l;
				return {
					h: round(h),
					s: round(s),
					l: round(l)
			...
			set: function set(value) {
				this.hsv = _extends({}, IroColor.hslToHsv(value), { a: value.a === void 0 ? 1 : value.a });
			}
		},
		{
			key: "hsla",
			get: function get() {
				return _extends({}, this.hsl, { a: this.alpha });
			},
			set: function set(value) {
				this.hsl = value;
			}
...
function getCurrentSliderValue(props, color) {
	...
	switch (props.sliderType) {
		case "red": return rgb.r / 2.55;
		case "green": return rgb.g / 2.55;
		case "blue": return rgb.b / 2.55;
		case "alpha": return hsva.a * 100;
		case "kelvin":
			var minTemperature = props.minTemperature;
			var temperatureRange = props.maxTemperature - minTemperature;
			var percent = (color.kelvin - minTemperature) / temperatureRange * 100;
			return Math.max(0, Math.min(percent, 100));
		case "hue": return hsva.h /= 3.6;
		case "saturation": return hsva.s;
		default: return hsva.v;
	}
}
/**
...
function getSliderValueFromInput(props, x, y) {
	...
	var handlePos;
	if (props.layoutDirection === "horizontal") handlePos = -1 * y + handleRange + handleStart;
	else handlePos = x - handleStart;
	handlePos = Math.max(Math.min(handlePos, handleRange), 0);
	var percent = Math.round(100 / handleRange * handlePos);
	switch (props.sliderType) {
		case "kelvin":
			var minTemperature = props.minTemperature;
			return minTemperature + (props.maxTemperature - minTemperature) * (percent / 100);
		case "alpha": return percent / 100;
		case "hue": return percent * 3.6;
		case "red":
		case "blue":
		case "green": return percent * 2.55;
...
function getSliderHandlePosition(props, color) {
	...
	if (ishorizontal) handlePos = -1 * handlePos + handleRange + handleStart * 2;
	return {
...
function getSliderGradient(props, color) {
	...
	var rgb = color.rgb;
	switch (props.sliderType) {
		case "red": return [[0, "rgb(0," + rgb.g + "," + rgb.b + ")"], [100, "rgb(255," + rgb.g + "," + rgb.b + ")"]];
		case "green": return [[0, "rgb(" + rgb.r + ",0," + rgb.b + ")"], [100, "rgb(" + rgb.r + ",255," + rgb.b + ")"]];
		case "blue": return [[0, "rgb(" + rgb.r + "," + rgb.g + ",0)"], [100, "rgb(" + rgb.r + "," + rgb.g + ",255)"]];
		case "alpha": return [[0, "rgba(" + rgb.r + "," + rgb.g + "," + rgb.b + ",0)"], [100, "rgb(" + rgb.r + "," + rgb.g + "," + rgb.b + ")"]];
		case "kelvin":
			var stops = [];
...
function getBoxGradients(props, color) {
	return [[[0, "#fff"], [100, "hsl(" + color.hue + ",100%,50%)"]], [[0, "rgba(0,0,0,0)"], [100, "#000"]]];
}
var BASE_ELEMENTS;
/**
...
function getHandleAtPoint(props, x, y, handlePositions) {
	for (var i = 0; i < handlePositions.length; i++) {
		...
		if (Math.sqrt(dX * dX + dY * dY) < props.handleRadius) return i;
	}
	return null;
}
...
var IroComponentWrapper = /* @__PURE__ */ function(Component) {
	...
	IroComponentWrapper.prototype.render = function render(props) {
		...
		if (props.index > 0) rootStyles[isHorizontal ? "marginLeft" : "marginTop"] = margin;
	...
	IroComponentWrapper.prototype.handleEvent = function handleEvent(e) {
		...
		switch (e.type) {
			case "mousedown":
			case "touchstart":
				if (inputHandler(x, y, 0) !== false) SECONDARY_EVENTS.forEach(function(event) {
...
function IroHandle(props) {
	...
	}, url && h("use", Object.assign({ xlinkHref: resolveSvgUrl(url) }, props.props)), !url && h("circle", {
		cx,
		cy,
		r: radius,
		fill: "none",
...
function IroBox(props) {
	...
	function handleInput(x, y, inputType) {
		if (inputType === 0) {
			...
			if (activeHandle !== null) colorPicker.setActiveColor(activeHandle);
			else {
	...
	return h(IroComponentWrapper, Object.assign({}, props, { onInput: handleInput }), function(uid, rootProps, rootStyles) {
		return h("div", Object.assign({}, rootProps, {
			...
			style: Object.assign({}, {
				...
				height: "100%",
				borderRadius: cssValue(radius)
			}, cssBorderStyles(props), { background: cssGradient("linear", "to bottom", gradients[1]) + "," + cssGradient("linear", "to right", gradients[0]) })
...
function IroWheel(props) {
	var width = getWheelDimensions(props).width;
	var colors = props.colors;
	props.borderWidth;
	var colorPicker = props.parent;
	...
	function handleInput(x, y, inputType) {
		if (inputType === 0) {
			if (!isInputInsideWheel(props, x, y)) return false;
			var activeHandle = getHandleAtPoint(props, x, y, handlePositions);
			if (activeHandle !== null) colorPicker.setActiveColor(activeHandle);
			else {
				colorPicker.inputActive = true;
	...
	return h(IroComponentWrapper, Object.assign({}, props, { onInput: handleInput }), function(uid, rootProps, rootStyles) {
		return h("div", Object.assign({}, rootProps, {
			...
			style: Object.assign({}, circleStyles, { background: "radial-gradient(circle closest-side, #fff, transparent)" })
...
function createWidget(WidgetComponent) {
	var widgetFactory = function(parent, props) {
		...
		if (document.readyState !== "loading") mountWidget();
...
var IroColorPicker = /* @__PURE__ */ function(Component) {
	function IroColorPicker(props) {
		...
		this.deferredEvents = {};
		this.id = props.id;
		(props.colors.length > 0 ? props.colors : [props.color]).forEach(function(colorValue) {
	...
	*/
	IroColorPicker.prototype.removeColor = function removeColor(index) {
		...
		if (this.state) this.setState({ colors: this.colors });
		if (color.index === this.color.index) this.setActiveColor(0);
	...
	*/
	IroColorPicker.prototype.emit = function emit(eventType) {
		...
		if (!(activeEvents.hasOwnProperty(eventType) ? activeEvents[eventType] : false)) {
	...
	*/
	IroColorPicker.prototype.emitInputEvent = function emitInputEvent(type, originId) {
		if (type === 0) this.emit("input:start", this.color, originId);
		else if (type === 1) this.emit("input:move", this.color, originId);
		else if (type === 2) this.emit("input:end", this.color, originId);
	};
	IroColorPicker.prototype.render = function render(props, state) {
		...
		if (!Array.isArray(layout)) {
			switch (layout) {
				default: layout = [{ component: IroWheel }, { component: IroSlider }];
			}
			if (state.transparency) layout.push({
				component: IroSlider,
